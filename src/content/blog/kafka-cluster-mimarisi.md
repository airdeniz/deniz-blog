...
Buraya kadar veriyi Kafka'ya nasıl soktuğumuzu (CDC) ve içeride nasıl durduğunu
konuştuk. Peki bu veriyi Kafka'dan alıp nihai bir hedefe — örneğin bir **Iceberg**
tablosuna ya da **BigQuery**'ye — yazmak istediğimizde ne kullanırız?
